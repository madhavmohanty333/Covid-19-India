...
const new_revovered_element = document.querySelector(".recovered .new-value");
...
function updateStats(){
	...
	new_revovered_element.innerHTML = `+${parseInt(last_entry.total_recovered.replace(/,/g, "")) - parseInt(before_last_entry.total_recovered.replace(/,/g, ""))}`;
